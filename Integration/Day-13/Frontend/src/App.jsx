    ...
    <>
         <BrowserRouter>
          {/* Wrap routes using <Header/> in a <Route> or <React.Fragment> */}
           <Routes>
            <Route path="/" element={<> <Header1 cartItems={cartItems} /> <Home /> </>}/>
            <Route path="/Login" element={<Login />} />
            <Route path="/aboutus" element={<> <Header1 cartItems={cartItems}/> <Aboutus/></>} />
            <Route path="/contact" element={<> <Header1 cartItems={cartItems}/> <ContactUs/></>} />
             <Route path="/Register" element={<Register />} />

             <Route path="/header" element={<> <Header cartItems={cartItems} /> <Home /> </>}/>
